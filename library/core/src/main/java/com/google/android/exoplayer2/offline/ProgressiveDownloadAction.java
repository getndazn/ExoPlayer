...
public final class ProgressiveDownloadAction extends DownloadAction {
  ...
  public static final Deserializer DESERIALIZER =
      new Deserializer(TYPE, VERSION) {
        ...
        public ProgressiveDownloadAction readFromStream(int version, DataInputStream input)
          ...
          return new ProgressiveDownloadAction(uri, isRemoveAction, isPaused, data, customCacheKey);
        }
      };
  ...
  public ProgressiveDownloadAction(
      Uri uri, boolean isRemoveAction, boolean isPaused, @Nullable byte[] data, @Nullable String customCacheKey) {
